...
func TestHandlerSupportsContentValidation(t *testing.T) {
	...
	handler.ServeHTTP(first, httptest.NewRequest(http.MethodGet, "/_gosx/studio/media-runtime.js", nil))
	...
	request := httptest.NewRequest(http.MethodGet, "/_gosx/studio/media-runtime.js", nil)
