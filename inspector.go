...
func RenderInspectorControl(control map[string]any, formID, inputName string) gosx.Node {
	...
	actionLabel := FirstNonEmpty(workbenchMapString(control, "actionLabel"), "Save field")
