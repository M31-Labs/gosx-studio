...
func TestRenderWorkbenchFrameUsesShellViewChrome(t *testing.T) {
	...
	for _, want := range []string{
		...
		`role="toolbar"`,
		`aria-label="Preview selection actions"`,
		`data-studio-preview-dock-title="true"`,
		`data-gosx-studio-preview-dock-label="true"`,
		`data-gosx-studio-preview-breadcrumb="true"`,
		`data-gosx-studio-preview-dock-kind="true"`,
		`data-studio-preview-field-count="true"`,
		`data-gosx-studio-preview-field-meter="true"`,
		`data-studio-preview-action="content"`,
		`data-gosx-studio-preview-command="content"`,
		`data-studio-preview-action="style"`,
		`data-studio-preview-action="move-up"`,
		`data-studio-preview-action="move-down"`,
		`data-studio-preview-action="inline-text"`,
		`data-studio-preview-action="toggle-visibility"`,
