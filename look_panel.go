...
func renderLookPanelGroupSlot(view map[string]any, key, title, summary string, children ...gosx.Node) gosx.Node {
	return gosx.El("section", gosx.Attrs(
		...
		gosx.Attr("data-studio-look-group-selected", BoolAttr(workbenchMapString(view, "defaultGroupKey") == key)),
	),
		gosx.El("header", nil,
...
func renderLookStyleScope(scope map[string]any) gosx.Node {
	return gosx.El("div", gosx.Attrs(
		...
		gosx.Attr("data-style-valid", BoolAttr(workbenchMapBool(scope, "valid"))),
