...
func TestRenderHomeLayersPanelSegmentsNonEmpty(t *testing.T) {
	view := map[string]any{
		...
		"items": []map[string]any{{
			...
			"orderInputAttrs": map[string]any{"class": "home-section-order", "type": "hidden", "name": "home_sections[0][order]", "value": "0", BlockLayoutOrderAttr: "true"},
			"handleAttrs":     map[string]any{"class": "home-section-handle", "type": "button", "aria-label": "Drag Hero", BlockLayoutHandleAttr: "true"},
			"statusAttrs":     map[string]any{"class": "status-pill", BlockLayoutPillAttr: "true"},
			...
			"visibilityAttrs":    map[string]any{"type": "checkbox", "name": "home_sections[0][enabled]", BlockLayoutVisibleAttr: "true", "checked": true},
			"hiddenEnabledAttrs": map[string]any{"type": "hidden", "name": "home_sections[0][enabled]", "value": "off"},
			"upButtonAttrs":      map[string]any{"class": "home-section-move", "type": "button", BlockLayoutMoveAttr: "up", "aria-label": "Move Hero up"},
			"downButtonAttrs":    map[string]any{"class": "home-section-move", "type": "button", BlockLayoutMoveAttr: "down", "aria-label": "Move Hero down"},
		}},
	}
