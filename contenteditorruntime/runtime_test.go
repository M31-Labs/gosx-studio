...
func TestScriptExposesSharedContentEditorRuntimeContract(t *testing.T) {
	...
	for _, check := range []string{
		...
		"POINTER_SCROLL_EDGE",
		"POINTER_SCROLL_STEP",
		"data-content-editor-pointer-dragging",
		"data-content-editor-pointer-type",
		"data-content-editor-pointer-source",
		"data-content-editor-pointer-reduced-motion",
		"pointercancel",
		"lostpointercapture",
		"setPointerCapture",
		...
		"removePointerRemovalObserver",
		"removedNodes",
		"drag.row.isConnected",
		"drag.handle.isConnected",
		"insideViewport",
		"prefersReducedMotion",
		"pointerTargetChangesOrder",
		"pointerDropTarget",
