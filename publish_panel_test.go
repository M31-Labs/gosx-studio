...
func TestRenderPublishPanelFull(t *testing.T) {
	...
	for _, fragment := range []string{
		...
		`<button class="button button--primary" type="submit" form="websiteEditorForm" formaction="/publish" formmethod="post" data-admin-confirm="Publish this draft?" data-studio-submit-action="publish" data-studio-field-action-formaction="/publish">Publish</button>`,
		`<button class="button button--ghost" type="submit" form="websiteEditorForm" formaction="/discard" formmethod="post" data-admin-confirm="Discard unpublished changes?" data-studio-submit-action="discard" data-studio-field-action-formaction="/discard">Discard changes</button>`,
